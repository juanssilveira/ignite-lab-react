...
export type Lesson = Node & {
  __typename?: 'Lesson';
  avaliableAt?: Maybe<Scalars['DateTime']>;
...
export type LessonManyWhereInput = {
  ...
  /** All values that are contained in given list. */
  avaliableAt_in?: InputMaybe<Array<Scalars['DateTime']>>;
  /** All values less than the given value. */
  ...
  /** All values that are not contained in given list. */
  avaliableAt_not_in?: InputMaybe<Array<Scalars['DateTime']>>;
...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, slug: string, lessonType: LessonType, avaliableAt?: any | null, title: string }> };
...
export type GetSubscriberByEmailQuery = { __typename?: 'Query', subscribers: Array<{ __typename?: 'Subscriber', id: string, email: string }> };
...
export const GetSubscriberByEmailDocument = gql`
  ...
  subscribers(stage: DRAFT, where: {email: $email}) {
    id
    email
  }
}
